...
const Comment = (props) => {
	...
	const { commentText, commentPoster, repliedTo, timePosted, children, uuid } = props.userComment
		...
		<div className='Comment  card p-3'>
			<div className="d-flex justify-content-between align-items-center">
                <div className="user d-flex flex-row align-items-center">
                    <img src="#" alt="profile" width="30" className="user-img rounded-circle mr-2" /> 
                    <span>
